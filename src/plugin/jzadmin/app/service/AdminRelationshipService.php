...
use plugin\jzadmin\app\model\AdminRelationship;
...
class AdminRelationshipService extends AdminService
{
    ...
    {
        $iterator = new RecursiveIteratorIterator(new RecursiveDirectoryIterator(app_path('model'))); // webman
...
namespace app\model; // webman

use plugin\jzadmin\app\model\BaseModel as Model;
