...
use plugin\jzadmin\app\renderer\Card;
use plugin\jzadmin\app\renderer\Form;
use plugin\jzadmin\app\renderer\Flex;
use plugin\jzadmin\app\renderer\CRUDTable;
use plugin\jzadmin\app\renderer\DialogAction;
use plugin\jzadmin\app\renderer\ComboControl;
use plugin\jzadmin\app\service\AdminMenuService;
use plugin\jzadmin\app\trait\IconifyPickerTrait;
use plugin\jzadmin\app\controller\AdminController;
use plugin\jzadmin\app\support\CodeGenerator\Generator;
use plugin\jzadmin\app\service\AdminCodeGeneratorService;
use plugin\jzadmin\app\support\CodeGenerator\GenCodeClear;
use plugin\jzadmin\app\support\CodeGenerator\FilterGenerator;
...
class CodeGeneratorController extends AdminController
{
                ...
                amis()->Tab()->title(admin_trans('admin.code_generators.route_config'))->body(
                    amis()->ComboControl('menu_info', false)->multiLine()->subFormMode('horizontal')->items([
                        ...
                        amis()->TreeSelectControl('parent_id', admin_trans('admin.code_generators.parent_menu'))
                            ...
                            ->value(0)
                            ->source('${menu_tree}'),
                        $this->iconifyPicker('icon', admin_trans('admin.code_generators.menu_icon'))
                            ->value('ph:circle'),
                    ])
                ),
                // 页面配置
    ...
    public function getPropertyOptions(Request $request): Response
    {
        ...
        $className = '\\plugin\\jzadmin\\renderer\\' . $request->input('c');
    ...
    public function formData($directReturn = false): Response|array
    {
        ...
        //         'value' => [
        //             'controller_path' => $namespace . 'controller/', // webman
        //             'service_path'    => $namespace . 'service/', // webman
        //             'model_path'      => $namespace . 'model/', // webman
        //         ],
        //     ];
        // }
