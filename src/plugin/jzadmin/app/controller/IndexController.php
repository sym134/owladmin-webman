...
use plugin\jzadmin\app\model\Extension;
use plugin\jzadmin\app\service\AdminPageService;
...
class IndexController extends AdminController
{
    ...
    public function settings(): Response
    {
        ...
        return $this->response()->success([
            ...
            'locale'   => settings()->get('admin_locale', config('plugin.jzadmin.translation.locale')), // webman
