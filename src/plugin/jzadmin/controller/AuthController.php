...
use plugin\jzadmin\support\Captcha;
use plugin\jzadmin\renderer\TextControl;
use plugin\jzadmin\renderer\ImageControl;
...
JS,
     ...
     * 刷新验证码
     *
     * @return JsonResponse|\Illuminate\Http\Resources\Json\JsonResource
     */
