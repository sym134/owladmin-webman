...
namespace plugin\jzadmin\controller\DevTools;
...
use plugin\jzadmin\trait\IconifyPickerTrait;
use plugin\jzadmin\controller\AdminController;
use plugin\jzadmin\support\CodeGenerator\Generator;
use plugin\jzadmin\service\AdminCodeGeneratorService;
use plugin\jzadmin\support\CodeGenerator\GenCodeClear;
...
class CodeGeneratorController extends AdminController
{
    ...
    public function getPropertyOptions(Request $request)
    {
        ...
        $className = '\\plugin\\jzadmin\\renderer\\' . $request->c;
     ...
     * 字段表单
     *
     * @return \plugin\jzadmin\renderer\Card
     */
     ...
     * 预览代码 按钮
     *
     * @return \plugin\jzadmin\renderer\DialogAction
     */
     ...
     * @return Response
     */
    public function genRecordOptions(): \support\Response
    {
