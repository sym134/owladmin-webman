...
use support\Request;
use Jizhi\JzAdmin\facades\File;
...
use plugin\jzadmin\support\CodeGenerator\ModelGenerator;
use plugin\jzadmin\support\CodeGenerator\RouteGenerator;
use plugin\jzadmin\support\CodeGenerator\ServiceGenerator;
use plugin\jzadmin\support\CodeGenerator\MigrationGenerator;
                        ...
                        amis()->GroupControl()->body([
                            amis()->GroupControl()->direction('vertical')->body([
                                ...
                                amis()
                                    ...
                                    ->value($this->getNamespace('controller') . '${' . $nameHandler . '}Controller'),
                                amis()
                                    ->TextControl('service_name', __('admin.code_generators.service_name'))
                                    ->value($this->getNamespace('service', 1) . '${' . $nameHandler . '}Service'),
                                amis()
