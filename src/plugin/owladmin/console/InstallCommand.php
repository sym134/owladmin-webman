...
namespace plugin\owladmin\console;
...
class InstallCommand extends Command
{
    ...
    public function createHomeController(): void
    {
        ...
        $this->laravel['files']->put(
            $homeController,
            str_replace('{{Namespace}}', config('plugin.owladmin.admin.route.namespace'), $contents)
        );
    ...
    {
        $base = str_replace('\\controller', '\\', config('plugin.owladmin.admin.route.namespace'));
