...
use plugin\jzadmin\app\trait\ErrorTrait;
...
class Extension
{
     ...
     * @return bool
     */
    public function createDir($name, $namespace): bool
    {
    ...
    protected function makeFiles()
    {
        ...
        $this->putFile("src/http/controller/{$this->className}Controller.php", $controllerContent);
