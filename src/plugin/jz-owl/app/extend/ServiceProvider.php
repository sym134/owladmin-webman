...
namespace plugin\jzadmin\app\extend;
...
use plugin\jzadmin\app\support\ComposerProperty;
...
abstract class ServiceProvider extends LaravelServiceProvider
{
    ...
    public function uninstall(): void
    {
        ...
        \plugin\jzadmin\app\model\Extension::query()->where('name', $this->getName())->delete();
    }
