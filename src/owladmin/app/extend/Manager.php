...
use plugin\owladmin\app\support\Zip;
use Illuminate\Filesystem\Filesystem;
use plugin\owladmin\app\support\Helper;
use plugin\owladmin\app\support\Composer;
use Psr\Container\NotFoundExceptionInterface;
use Psr\Container\ContainerExceptionInterface;
use plugin\owladmin\app\model\Extension as ExtensionModel;

/**
 * 拓展 todo 删除
 * Manager
 * plugin\owladmin\app\extend
 *
 * Author:sym
 * Date:2024/6/15 下午8:58
 * Company:极智网络科技
 */
class Manager
{
     ...
     * @return array
     */
    public function getExtensionDirectories(string $dirPath = null): array
    {
        $extensions = [];
     ...
     */
    public function addExtension(ServiceProvider $serviceProvider): void
    {
