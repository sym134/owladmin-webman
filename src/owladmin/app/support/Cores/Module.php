...
class Module
{
    ...
    {
        $this->namespace = config('plugin.owladmin.admin.modules_namespace', 'AdminModules');
        $this->dir       = config('plugin.owladmin.admin.modules_dir', 'admin-modules');
    }
     ...
     */
    public static function current(bool $lower = false): mixed
    {
    ...
    {
        $modules = config('plugin.owladmin.admin.modules', []); // webman
