...
use plugin\owladmin\app\support\CodeGenerator\Generator;
use plugin\owladmin\app\service\AdminCodeGeneratorService;
use plugin\owladmin\app\support\CodeGenerator\GenCodeClear;
use plugin\owladmin\app\support\CodeGenerator\FilterGenerator;
...
class CodeGeneratorController extends AdminController
{
    ...
    public function getPropertyOptions(Request $request): Response
    {
        ...
        $className = '\\plugin\\owladmin\\renderer\\' . $request->input('c');
