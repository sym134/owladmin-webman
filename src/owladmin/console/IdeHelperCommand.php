...
EOF;
        ...
        file_put_contents(config('plugin.owladmin.admin.directory') . '/.phpstorm.meta.php', $text);
    }
    ...
    public function pushMeta($text, $tab = 1)
    {
        ...
        file_put_contents(config('plugin.owladmin.admin.directory') . '/.phpstorm.meta.php', $tabs . $text . PHP_EOL, FILE_APPEND);
    }
